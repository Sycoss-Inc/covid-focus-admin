...
function Panchayat() {
  ...
  const fetchData = () => {
    setIsLoading(true);
    fetch(
      "https://covid-focus-sycoss.herokuapp.com/client/notices?panchayat=veloor_panchayat&record=5"
    ).then((res) =>
      res
        .json()
        .then((body) => {
  ...
  return (
    <>
      ...
      <div className="left-0 sm:left-14 mt-14 sm:mt-0 lg:left-64 right-0 bg-gray-100 rounded-b-lg shadow fixed z-20">
        <div className="p-1 pl-4 sm:p-4 text-lg sm:text-2xl">Notices</div>
      </div>
